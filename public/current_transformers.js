...
function CurrentTransformers({relay, dropDownTable, compare, cell, dropDownRelaysList, dropDownRangeList, dropDownDeviceTypeList, 
    newInputRelayRef, newInputRangeRef, newInputDeviceTypeRef, deleteRow, name, fider, addNew, sortRelay}){
    return(
        <>
            <Row className ='tableLabel'>
            <Button className="addNew" variant="primary" size="sm" id="add_transTable" onClick={(e)=>addNew(e, name, fider)}>Add new</Button>
                ...
                relay.map((item, index)=>(
                    <tr key={index}>
                        ...
                        <td onClick={(e)=>dropDownTable(e)}>
                            {compare(cell,index,2,"transTable")?
                            <DropDownRelays 
                        ...
                        <td onClick={(e)=>dropDownTable(e)}>
                            {compare(cell,index,3,"transTable")?
                            <DropDownDeviceType 
                        ...
                        <td onClick={(e)=>dropDownTable(e)}>
                            {compare(cell,index,4,"transTable")?
                            <DropDownRange
                        ...
                        <td onClick={(e)=>dropDownTable(e)}>
                            {compare(cell,index,5,"transTable")? <Form.Control size="sm" type="text" autofocus="autofocus"/>:item[5]}
                        </td>
                        <td onClick={(e)=>dropDownTable(e)}>
                            {compare(cell,index,6,"transTable")? <Form.Control size="sm" type="text" autofocus="autofocus"/>:item[6]}
                        </td>
